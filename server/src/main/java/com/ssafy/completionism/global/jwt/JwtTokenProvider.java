package com.ssafy.completionism.global.jwt;
...
public class JwtTokenProvider {
    ...
    private long accessTokenValidTime = 60 * 60 * 1000L; // 토큰 유효시간 1시간
    ...
    public JwtToken generateToken(Authentication authentication, String name, String phone) {
